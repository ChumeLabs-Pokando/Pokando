...
public class EventoService extends ServiceAdapter<Evento, Long, EventoResponse, EventoRequest, EventoRequest> {
    ...
    public EventoService(UserAcessoRepository userAcessoRepository, EventoRepository repository, EventoMapper mapper, ClienteRepository clienteRepository, OrganizadorRepository organizadorRepository, IngressoRepository ingressoRepository) {
    ...
    public Evento create(EventoRequest request) {
        var entity = ((EventoMapper) mapper).toEntity(request, clienteRepository, organizadorRepository, ingressoRepository);
