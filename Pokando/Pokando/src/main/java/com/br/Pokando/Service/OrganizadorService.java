...
public class OrganizadorService  extends ServiceAdapter<Organizador, Long, OrganizadorResponse, OrganizadorRequest,OrganizadorRequest>{
    ...
    public OrganizadorService(OrganizadorRepository repository, OrganizadorMapper mapper, UserAcessoRepository userAcessoRepository) {
    ...
    public Organizador create(OrganizadorRequest request) {
        var entity = ((OrganizadorMapper) mapper).toEntity(request, userAcessoRepository);
